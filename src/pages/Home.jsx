...
const Home = () => {
    ...
    return (
        <div className="homeContainer">
            ...
            <div className="third">
                <img src={bg2} alt="" style={{position:'static', zIndex: '-1', marginTop: '-300px', width:"100%", height:"100%", overflow: 'hidden'}}/>
                <p className="Dela" style={{margin: '80px', position:"absolute", marginTop: '-20px'}}>Проекты</p>
